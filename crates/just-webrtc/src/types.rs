...
pub struct ICECandidate {
    ...
    /// this candidate is known as the "end-of-candidates" marker.SDP string describing the properties of the candidate
    ...
    /// within the SDP of the media description, or None if no such associated exists.
    #[serde(rename = "sdpMLineIndex")]
    pub sdp_mline_index: Option<u16>,
    /// A string containing the username fragment (usually referred to in shorthand as "ufrag" or "ice-ufrag").
    /// This fragment, along with the ICE password ("ice-pwd"), uniquely identifies a single ongoing ICE interaction
    /// (including for any communication with the STUN server).
    ///
...
pub struct ICEServer {
    ...
    /// If the object represents a TURN server, this attribute specifies what kind of credential is to be used when connecting.
